...
void ObjectDictionary::InitObd(void){ 
  ...
  _ObdEntryList[7]._AccessMethod = static_cast<void (ObjectDictionaryEntryBase::*)(ObdAccessHandle*)>(&ControlProcessData::AccessMotorCurrentLimitRMS);

  _ObdEntryList[8]._Idx = 2163458;
